...
public interface DataAccessLogic extends Logic {
	...
	Card fetchCardByDescription(String className, String description);
	
	Map<String,String> getCardMapData(String className, String description);

	CMCard fetchCMCardByDescription(String className, String description);
	...
	void updateCardBatch(Card card);
	...
	File exportClassAsXlsFile(String className);

	CSVData importCsvFileFor(FileItem csvFile, Long classId, String separator) throws IOException, JSONException;
	
	XLSData importXlsFileFor(FileItem xlsFile, Long classId) throws IOException, JSONException;
