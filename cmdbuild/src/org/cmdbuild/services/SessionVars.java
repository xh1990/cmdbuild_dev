...
public class SessionVars implements AuthenticationStore, LanguageStore {
	...
	private static final String XLSDATA_KEY = "xlsdata";
	...
	public XLSData getXlsData() {
		return (XLSData) valuesStore.get(XLSDATA_KEY);
	}

	public void setXlsData(final XLSData value) {
		valuesStore.set(XLSDATA_KEY, value);
	}
}
