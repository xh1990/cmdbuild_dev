(function() {
	...
	Ext.define("CMDBuild.view.management.utilities.CMModImportXLS", {
		...
		initComponent: function() {
			this.form = new CMDBuild.view.management.utilities.CMModImportXLS.UploadForm({
				region: "center",
				frame: true
			});

			this.grid = new CMDBuild.view.management.utilities.CMModImportXLS.Grid({
				region: "south",
				height: "80%",
				split: true
			});
	...
	Ext.define("CMDBuild.view.management.utilities.CMModImportXLS.UploadForm", {
	...
	Ext.define("CMDBuild.view.management.utilities.CMModImportXLS.Grid", {
